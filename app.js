...
const Settings = {
    ...
    difficulty: 'medium',
    playlist: [
        { name: "My mum is kinda homeless", src: "audio/my_mum_is_kinda_homeless.mp3" },
        { name: "No Batidão", src: "audio/no_batidao.mp3" },
        { name: "Murder In My Mind - Kordhell", src: "audio/murder_in_my_mind.mp3" },
        { name: "METAMORPHOSIS - INTERWORLD", src: "audio/metamorphosis.mp3" },
        { name: "RAVE - Dxrk ダーク", src: "audio/rave.mp3" },
        { name: "Close Eyes - DVRST", src: "audio/close_eyes.mp3" },
        { name: "NEON BLADE - MoonDeity", src: "audio/neon_blade.mp3" },
        { name: "Sahara - Hensonn", src: "audio/sahara.mp3" },
        { name: "GigaChad Theme - g3ox_em", src: "audio/gigachad_theme.mp3" },
        { name: "9 In My Hand - Kordhell", src: "audio/9_in_my_hand.mp3" },
        { name: "Disaster - KSLV Noh", src: "audio/disaster.mp3" },
        { name: "Override - KSLV Noh", src: "audio/override.mp3" }
    ],
    ...
    init() {
        ...
        if(searchBtn && searchInp) {
            searchBtn.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    const matches = [
                        { n: "My mum is kinda homeless", src: "audio/my_mum_is_kinda_homeless.mp3" },
                        { n: "No Batidão", src: "audio/no_batidao.mp3" },
                        { n: "Murder In My Mind", src: "audio/murder_in_my_mind.mp3" },
                        { n: "METAMORPHOSIS", src: "audio/metamorphosis.mp3" },
                        { n: "RAVE", src: "audio/rave.mp3" },
                        { n: "Close Eyes", src: "audio/close_eyes.mp3" },
                        { n: "NEON BLADE", src: "audio/neon_blade.mp3" },
                        { n: "Sahara", src: "audio/sahara.mp3" },
                        { n: "GigaChad Theme", src: "audio/gigachad_theme.mp3" },
                        { n: "9 In My Hand", src: "audio/9_in_my_hand.mp3" },
                        { n: "Disaster", src: "audio/disaster.mp3" },
                        { n: "Override", src: "audio/override.mp3" }
                    ];
